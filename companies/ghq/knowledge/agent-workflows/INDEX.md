...
|------|-------|---------|------------|---------|
| [prompt-chaining-for-reviewer-agents.md](prompt-chaining-for-reviewer-agents.md) | Prompt Chaining for Reviewer Agent Templates | Restructuring monolithic reviewer prompts into two-phase chains (research → review) improves accu... | 0.8 | 2026-03-25 |
...
| [semantic-vs-llm-tool-routing-tradeoffs.md](semantic-vs-llm-tool-routing-tradeoffs.md) | Semantic Routing vs LLM Dispatch: Production Tradeoffs | Two primary strategies for runtime tool selection: embedding similarity (fast, cheap) vs LLM reas... | 0.9 | 2026-03-20 |
