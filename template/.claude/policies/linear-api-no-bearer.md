...
Linear API keys are not OAuth tokens. The API returns a clear error: "It looks like you're trying to use an API key as a Bearer token. Remove the Bearer prefix." This applies to all Linear workspaces ({company}, {Product}, {company}).
