...
When publishing a new blog article (writing MDX to `repos/private/personal-website/src/content/blog/`), always draft an X post to share the article before deploying.

**Workflow:**
1. Write the blog article MDX
2. Draft an X teaser post that hooks the reader and links to the article
