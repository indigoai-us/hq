...
{Company} US-002 initially only referenced bootcamp transcripts. User corrected to include blog + social drafts. The enriched extraction (121KB across 4 files from 100+ sources) was significantly more useful than transcripts alone would have been.
