...
A kickoff email to a client was once sent from the wrong Gmail account (personal instead of business) with a garbled subject line. The business account auth was broken, and Claude fell back to personal without asking. This sent a broken, unprofessional email to the client. This must never happen again.
