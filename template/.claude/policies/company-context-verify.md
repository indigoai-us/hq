...
Company policies contain hard-won instructions for specific services (e.g. "use Vercel API, not CLI for {your-domain}.ai domains"). Skipping them means repeating known failures. The manifest now has infrastructure mappings to eliminate guessing.
