...
created: 2026-02-22
updated: 2026-03-12
source: subdomain overwrite incident
---
...
Protected domains (never reassign): `app.{your-domain}.com`, `api.{your-domain}.com`, `{your-domain}.com`, `{company}.com`, `www.{company}.com`

## Rationale

A production subdomain was overwritten by deploying to the wrong Vercel project. The deploy registry (`settings/deploy-registry.yaml`) is the source of truth for repo → project → domain mapping.
