...
Discovered during {product} landing page design session. Multiple attempts to constrain text width (on the node, on a wrapper div, with flexShrink) all failed. Manual line breaks were the only reliable solution in Paper.
