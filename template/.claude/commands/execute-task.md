...
If repo is `repos/private/{company}-site`, also run:
```bash
...
- **{Company} E2E enforcement** - When repo is {company}-site, back pressure includes manifest freshness + coverage check. Workers must update/add E2E tests for modified pages.
