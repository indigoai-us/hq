...
qmd context add qmd://{repo} "{repo} monorepo: Nx monorepo for {Product}/Acme Corp. Apps (web-admin, web-client, web-front, function, acme, cdp) + libs (core, db, ui, web, util, schema). Next.js, React 19, TypeScript, SST, Prisma, PostgreSQL."
