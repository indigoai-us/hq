...
qmd context add qmd://{product} "{Product} monorepo: Nx monorepo for Voyage/{Company-1}. Apps (web-admin, web-client, web-front, function, {company-1}, cdp) + libs (core, db, ui, web, util, schema). Next.js, React 19, TypeScript, SST, Prisma, PostgreSQL."
