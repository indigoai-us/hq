...
qmd context add qmd://hq/companies "Five company-scoped directories ({Company-1}, {Company-2}, {Company-3}, Personal, Band-TBD) each with knowledge bases, settings, and data."
...
qmd context add qmd://{product} "{Product} monorepo: Nx monorepo for {Product}/{Company-1}. Apps (web-admin, web-client, web-front, function, {company-1}, cdp) + libs (core, db, ui, web, util, schema). Next.js, React 19, TypeScript, SST, Prisma, PostgreSQL."
qmd context add qmd://{product}/apps "Application code: Next.js web apps, AWS Lambda functions, {Company-1} SMS platform, CDP."
