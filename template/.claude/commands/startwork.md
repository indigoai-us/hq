...
- **Arg matches company slug** in `companies/manifest.yaml` ({company-1}, {company-2}, {company}, personal, {company-3}, {company-4}, {company-5}, {company-6}, {company-7}, {company-8}) → Company mode
