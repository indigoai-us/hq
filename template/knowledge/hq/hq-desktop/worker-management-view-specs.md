...
│ ┌─ Group: {company-1} (6) ────────────────────────────────────────┐ │
│ │ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐ ┌────────┐ │ │
│ │ │ cfo-lr       │ │ {co1}-analyst   │ │ infobip-adm  │ │ ...    │ │ │
...
| Company | Dropdown (multi-select) | {company-1}, {company-2}, {company-3}, personal, (public) | All |
| Status | Dropdown | Active, Inactive, All | Active |
| Search | Text input | Free-text filter on id, name, description | Empty |

**Filter behavior:**
- Filters are AND-combined (type=CodeWorker AND company={company-1})
...
| Company | No | {company-1}, {company-2}, {company-3}, personal, public |
