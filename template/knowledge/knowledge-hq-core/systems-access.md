...
| Slack | {Company-1} ({Product}) | Bot token (xoxb-) | `slack` MCP | `repos/public/slack-mcp/workspaces.json` |
...
| Stripe ({Product}) | {Company-1} | API keys | No | `companies/{company-1}/settings/stripe-voyage/` |
