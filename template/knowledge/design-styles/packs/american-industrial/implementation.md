...
`repos/private/{company}-site/src/templates/american-industrial.html`
...
|---------|---------|-------------|
| `{company}-industrial-redesign` | Warm (rust/brass/cream) | Full homepage, agent feed, stats grid, services |
| `{company}-brass-hands` | Dark (matches extension) | Texture system, terminal widget, card tilt, easter eggs |
