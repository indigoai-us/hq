...
- **Mobile PWA dashboard** -- access your HQ from any device at [example.com](https://example.com)
...
Once sync is running, access your HQ at [example.com](https://example.com):
