...
qmd context add qmd://hq/knowledge "HQ-level knowledge bases: coding methodology, worker framework patterns, dev-team practices, design styles, security framework, project templates."
