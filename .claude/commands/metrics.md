...
/metrics cfo-example-company      # Metrics for specific worker
/metrics --days 7             # Last 7 days only
/metrics cfo-example-company mrr  # Specific worker + skill
```
...
```json
{"ts":"2026-01-23T14:30:52.000Z","worker":"cfo-example-company","skill":"mrr","duration_ms":5000,"status":"completed","files":1}
```
...
```
/metrics cfo-example-company

cfo-example-company Metrics (last 30 days)
═══════════════════════════════════════════════════
