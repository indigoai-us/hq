...
Go from brand concept to execution-ready PRD with full company infrastructure in one interactive session. Based on a DTC launch playbook.
...
1. Brand name (display name, e.g. ACME)?
...
1. Target domain (e.g. wearacme.com)?
2. Existing Shopify store? (slug like "brand-1", or "none" to create later)
3. GitHub org for the repo (e.g. your-github-org)?
